...
%trace file
[time_p,packetsize_p] = textread('Eth.TL', '%f %f');

figure(1);
time_array = zeros(1,55000);
cumulative_arrival = zeros(1,55000);
...
%token bucket output
[arrival_time, packetsize_p2, back_log, num_of_tokens] = textread('Eth_bucket.txt', '%f %f %f %f');
...
%sink output
[packet_no_p3, arrival_time, packetsize_p3] = textread('Eth_output.txt', '%f %f %f');
