...
%token bucket output
[arrival_time, packetsize_p2, back_log, num_of_tokens] = textread('part3_bucket.txt', '%f %f %f %f');
...
%sink output
[packet_no_p3, arrival_time, packetsize_p3] = textread('part3_output.txt', '%f %f %f');
